...
docker run --name $DB_CONTAINER_NAME -e POSTGRES_PASSWORD=3a41fb35e0711ad2cddca5fe34ac85945b5aac18cb5ded222c7185a34f157961 -e POSTGRES_DB=demo -d -p 5432:5432 docker.io/postgres

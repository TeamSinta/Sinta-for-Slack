...
import { WebPageHeading } from "./_components/general-components";
...
<div className="max-w-10xl container mx-auto px-8 pb-40 pt-20 lg:pt-20">
      ...
      <FallInPlace delay={1}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 text-center">
          <div className="bg-white dark:bg-gray-800 text-black dark:text-white rounded-lg p-6 shadow-lg">
            <img src="https://assets-global.website-files.com/660df2204356cc0ae58476a5/660df2214356cc0ae58477e8_ico-1.png" className="mx-auto mb-4" width="42" alt="Easy-to-Deploy"/>
          ...
          <div className="bg-white dark:bg-gray-800 text-black dark:text-white rounded-lg p-6 shadow-lg">
            <img src="https://assets-global.website-files.com/660df2204356cc0ae58476a5/660df2214356cc0ae58477e8_ico-1.png" className="mx-auto mb-4" width="42" alt="Cost-Effective"/>
          ...
          <div className="bg-white dark:bg-gray-800 text-black dark:text-white rounded-lg p-6 shadow-lg">
            <img src="https://assets-global.website-files.com/660df2204356cc0ae58476a5/660df2214356cc0ae58477e7_ico-3.png" className="mx-auto mb-4" width="42" alt="Loved by Users"/>
  ...
  <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
    <div>
      <img src="https://assets-global.website-files.com/660df2204356cc0ae58476a5/66103735cbac916c3c9b60ae_brandbird%20(13)-p-800.jpg" className="rounded-lg shadow-lg w-full" alt=""/>
    </div>
  ...
  <div className="mt-20 grid grid-cols-1 lg:grid-cols-2 gap-16">
    ...
    <div className="order-1 lg:order-2">
      <img src="https://assets-global.website-files.com/660df2204356cc0ae58476a5/661035f8465159dae39c0cb6_sintaimage-p-800.jpg" className="rounded-lg shadow-lg w-full" alt=""/>
    </div>
  </div>
</div>
  ...
  <div className="text-center mb-20">
    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 mt-8">
      <div>
        <img src="https://assets-global.website-files.com/660df2204356cc0ae58476a5/661082a39ddd11fe69a0e588_63bf4122ced9145885a65b12_g-icon-green.png" className="mx-auto mb-4" height="100" alt="Greenhouse"/>
      ...
      <div>
        <img src="https://assets-global.website-files.com/660df2204356cc0ae58476a5/66108343ccff770399b666ca_Lever-233x175.png" className="mx-auto mb-4" height="100" alt="Lever"/>
        <h4 className="font-bold text-lg text-black dark:text-white">Lever</h4>
        <p className="text-black dark:text-gray-300">Applicant tracking system and hiring platform.</p>
      </div>
      <div>
        <img src="images/calendly-logo-vector-removebg-preview.png" className="mx-auto mb-4" height="100" alt="Calendly"/>
      ...
      <div>
        <img src="images/ashbylogo.png" className="mx-auto mb-4" height="100" alt="Ashby"/>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="flex flex-col items-center lg:items-start">
                <a href="/" aria-current="page" className="mb-6">
                  <img src="images/6457f2617575798a80fbb8d5_Pasted-Graphic-1.png" loading="lazy" width="150" alt="" className="invert-logo"/>
                </a>
              ...
              <div className="flex flex-col items-center lg:items-end">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="social-link-2">
                    <img src="images/x-logo.png" loading="lazy" alt="" className="social-icon no-invert" />
                  </a>
                  <a href="#" className="social-link-2">
                    <img src="images/icons8-facebook-240-1.png" loading="lazy" width="20" alt="" className="social-icon no-invert" />
                  </a>
                  <a href="#" className="social-link-2">
                    <img src="https://uploads-ssl.webflow.com/64dde8491796b73c619e78bf/64dde8491796b73c619e794d_social-4.png" loading="lazy" alt="" className="social-icon" />
                  </a>
                  <a href="#" className="social-link-2">
                    <img src="https://uploads-ssl.webflow.com/64dde8491796b73c619e78bf/64dde8491796b73c619e794c_social-3.png" loading="lazy" alt="" className="social-icon" />
                  </a>
                </div>
              </div>
            </div>

    ...
    for (const hiringroom of hiringRooms) {
        ...
        if (jobFitsConditions) {
            ...
            if (!hiringroom.slackChannelFormat) {
                console.log('No Slack Channel Format Found for Hiring Room', hiringroom.id);
                return;
            }
            ...
            console.log(`Slack Channel Created with ID: ${channelId} for Hiring Room ${hiringroom.id}`);
            ...
            if (channelId) {
              ...
              console.log(`Formatting Opening Message for Slack Channel ${channelId}`);
              ...
              console.log(`Sending and Pinning Message to Slack Channel ${channelId}`);
            ...
            console.log(`Job "${jobData.name}" did not meet conditions for hiring room "${hiringroom.id}".`);
        }
    }

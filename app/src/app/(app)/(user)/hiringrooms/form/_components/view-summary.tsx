            ...
            {formData.conditions.map((condition: any, index: number) => (
                <li key={index} className="flex items-center">
                    ...
                    >
                        ...
                        />
                        {condition.field || "No field specified"}
                    </Badge>
                    ...
                    <span
                        dangerouslySetInnerHTML={{
                            __html: badgeStyle(
                                condition.value || "No value specified"
                            ),
                        }}
                    />
                </li>
...
<Card className="mb-6 border border-gray-200">
    <div className="flex items-center justify-between p-6">
        <h3 className="font-heading text-lg font-semibold">Automated Actions</h3>
    </div>
    <div className="rounded-lg bg-gray-50 p-6 text-sm text-gray-700">
                    ...
                    {formData.actions.map((action: any, index: number) => (
                        <li key={index} className="flex flex-col gap-2">
                            <div>
                                <span
                                    dangerouslySetInnerHTML={{
                                        __html: badgeStyle(action.actionType || "No action specified", "green"),
                                    }}
                                />
                            </div>
                            ...
                            <div className="flex">
                                ...
                                >
                                    <Image
                                        ...
                                        className="mr-2 h-4 w-4"
                                    />
                                    {action.condition.field || "No field specified"}
                                </Badge>
                                <span className="mx-1 font-medium">
                                    {action.condition.condition || "No condition specified"}
                                </span>
                                <span
                                    dangerouslySetInnerHTML={{
                                        __html: badgeStyle(action.condition.value || "No value specified"),
                                    }}
                                />
                            </div>
                        </li>
                ...
                <div className="mt-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                        {formData.actions.map((action: any, actionIndex: number) =>
                            action.modifications.recipients && action.modifications.recipients.length > 0 ? (
                                action.modifications.recipients.map((recipient: Recipient, index: number) => (
                                 <>
                                  <h4 className="font-medium">Recipients:</h4>
                                    ...
                                    >
                                        <Image
                                            ...
                                            className="mr-1 h-4 w-4"
                                        />
                                        {recipient.label || "No recipient specified"}
                                    </Badge>
                                    </>
                                ))
                            ) : (

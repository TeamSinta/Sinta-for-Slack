...
function CreateHiringRoomSheet() {
    ...
    const [selectedHiringRoomType, setSelectedHiringRoomType] = useState("job");
    ...
    const handleSelectChange = (
        ...
        switch (field) {
            ...
            case "alertType":
                ...
                break;
            case "hiringRoomType":
                if (hiringRoomTypeOptions.some((option) => option.value === value)) {
                    setSelectedHiringRoomType(value);
                    form.setValue("hiringRoomType", value);
                }
                break;
            case "organizationId":
                    ...
                    >
                        ...
                        <div className="flex items-start gap-8">
                            ...
                            <div className="flex-1">
                                ...
                                <RadioGroup
                                    defaultValue={selectedHiringRoomType}
                                    onValueChange={(value) =>
                                        handleSelectChange(
                                            value,
                                            "",
                                ...
                                >
                                    {hiringRoomTypeOptions.map((option) => (
                                        <div
                                            key={option.value}
                        ...
                        <div className="flex items-start gap-8">
                            ...
                            <div className="flex-1 space-y-4 hide">

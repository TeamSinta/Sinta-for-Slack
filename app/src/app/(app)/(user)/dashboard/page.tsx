...
import { CheckCircleIcon, CogIcon, ArrowUpRight, Zap, ArrowDown, ChevronDown, Cable } from "lucide-react";
      ...
      <Card className="rounded-lg bg-background">
          <CardHeader className="flex flex-row items-center gap-2 rounded-sm bg-gray-50 px-4 py-3 dark:bg-gray-700">
              <div className="flex items-center">
                  <div className="mr-2 rounded-full bg-gray-200 text-gray-800 dark:bg-gray-600 dark:text-gray-200 h-7 w-7 flex items-center justify-center">1</div>
          ...
          <CardHeader className="flex flex-row items-center gap-2 rounded-sm bg-gray-50 px-4 py-3 dark:bg-gray-700">
              <div className="flex items-center">
                  {slackIntegration && greenhouseIntegration ? (
                      ...
                      <div className="mr-2 rounded-full bg-gray-200 text-gray-800 dark:bg-gray-600 dark:text-gray-200 h-7 w-7 flex items-center justify-center">2</div>
                  )}
                  <CardTitle className="text-lg font-semibold text-gray-800 dark:text-gray-200">
  ...
  return (
      ...
      >
          <div className="space-y-6 p-2">
              ...
              {(slackIntegration || greenhouseIntegration) && renderConnectionStatusCard()}
          </div>
      </AppPageShell>
  );
}

...
import { getColumns, type SlackChannelsCreatedData } from "./slackchannelscreated-columns"; // Adjust to include correct imports and types for hiringrooms
...
type SlackChannelsCreatedTableProps = {
    slackChannelsCreatedPromise: ReturnType<typeof getSlackChannelsCreatedPromise>;
...
export function AssignmentsChannelTable({ slackChannelsCreatedPromise, greenhouseCandidateDict, greenhouseJobsDict }: SlackChannelsCreatedTableProps) {
    ...
    const slackChannelsCreatedData: SlackChannelsCreatedData[] = data.map((slack_channel) => {
        ...
        return {
            ...
            greenhouseCandidateInitials: curCand ? (curCand.first_name[0] + curCand.last_name[0]).toUpperCase() : "",
            greenhouseCandidateName: curCand ? curCand.first_name+" "+curCand.last_name : "",

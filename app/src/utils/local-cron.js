...
if (process.env.NEXT_PUBLIC_NODE_ENV === 'development' || process.env.NEXT_PUBLIC_BRANCH_NAME !== 'main') {
  ...
  cron.schedule('0 * * * *', async () => {
    try {
      ...
      const apiUrl = process.env.NEXT_PUBLIC_API_BASE_URL + "/api/rotation";

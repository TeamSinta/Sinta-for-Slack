...
export async function sendSlackNotification(
  ...
  for (const recipient of allRecipients) {
    ...
    const channel = recipient.source === "greenhouse" ? recipient.slackValue : recipient.value;
              ...
              return [
                {
                  ...
                  text: {
                    ...
                    text: workflowRecipient.messageFields
                      .map((field: string) => {
                        if (field === "interview_id") return ""; // Skip interview_id in the message
                ...
                },
                {
                  ...
                  elements: workflowRecipient.messageButtons.map((button) => {
                    ...
                    if (button.type === "UpdateButton") {
                      ...
                      buttonElement.action_id = button.action || `${button.type.toLowerCase()}_action_${interviewId}`;
                    }
